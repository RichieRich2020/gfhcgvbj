...
const EnrichBanner2: React.FC = () => {
  ...
  return (
    <div 
      className=" my-6 relative bg-gradient-to-r from-[#55A06F] to-[#55A06F] rounded-2xl p-4 max-w-4xl mx-auto shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer `"
      onClick={handleClick}
    >
      ...
      <div className="relative flex items-center justify-between">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex items-center w-[90%]">
            ...
            A holistic program to spark joy, balance, and purpose in work and life.
            </span>
